...
# and blog posts now arrive as data — velocirepo reads the site's RSS feeds
# into the `content` table, bodies included.
#
...
# Leaf pages only: /software/ is itself a listing, while /about/ is a real
# overview page.
